...
def run_recipe_evaluation(file_path):
    ...
    # Remove or bypass the existing cache to force re-embedding
    if os.path.exists(embeddings_cache_path):
        print("Removing existing cached recipe embeddings due to model change...")
        os.remove(embeddings_cache_path)  # This will delete the cache, forcing re-embedding
